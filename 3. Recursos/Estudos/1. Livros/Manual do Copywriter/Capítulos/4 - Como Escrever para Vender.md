...
author:
  - Robert W. Bly
description: Acrescentado metadados de Branding, devido ao tópico de Posicionamento
---
**"O OBJETIVO DA PUBLICIDADE É VENDER PRODUTOS"**, DISSE RAYMOND RUBICAM, da Young & Rubicam. "Não há outra justificativa digna de ser mencionada."

Para o copywriter iniciante, essa pode ser uma ideia nova. Se você já redigiu outros gêneros de texto — artigos de revistas, reportagens, ficção, redação técnica —, sabe como se expressar em português simples e claro. Você sabe como trabalhar com as palavras que informam e talvez até com aquelas que divertem ou entretêm. Mas agora você se depara com um novo desafio: escrever palavras que convençam o leitor a comprar o seu produto.

Isso coloca a maioria dos redatores em um terreno incerto. Você terá que fazer muitas escolhas e, a não ser que já tenha experiência em vendas ou publicidade, ainda não sabe como fazê-las.

Por exemplo, é preciso escrever diversas copies ou é melhor escrever uma copy curta? Se você escrever várias, as pessoas vão ler? Ou é verdade que as pessoas não leem anúncios com mais de dois parágrafos?

Você precisa de algum truque esperto, slogan ou modelo sexy para chamar a atenção do leitor? Ou você deve se concentrar no produto quando escreve?

Se seu produto tiver uma pequena vantagem sobre a concorrência, você deve se concentrar nessa vantagem? Ou deve se concentrar nos benefícios gerais que o produto oferece (que o leitor obtém tanto com o seu produto quanto com o do seu concorrente)? O que fazer no caso de não haver diferença entre seu produto e o da concorrência?

Como saber se o que você está escrevendo será convincente ou interessante para o leitor? Se você tiver duas ou três ideias para um anúncio, como escolher a melhor?  
Vamos começar a descobrir as respostas para essas perguntas.

# Recursos e benefícios

O primeiro passo para escrever uma copy que vende é mencionar os benefícios e não os recursos.

Recurso é um fato descritivo de um produto ou serviço; é o que o produto é ou tem. Benefício é o que o produto faz; é o que o usuário do produto ou serviço ganha como resultado do recurso.

Por exemplo, estou escrevendo este livro em um computador. Uma característica do PC é que ele me permite editar e revisar o que estou digitando eletronicamente, para que eu possa mover uma frase ou adicionar uma palavra sem ter que redigitar a página inteira. O benefício desse recurso é que economizo muito tempo e posso aumentar minha produtividade (e ganhar mais dinheiro) como resultado.

Outro exemplo: um segundo recurso do meu computador é que ele tem um teclado conectado à unidade principal com um cabo em espiral. A vantagem é que posso posicionar o teclado para ter o máximo conforto na hora de digitar.

Em seu panfleto "Por que esses vendedores não vendem", a Learning Dynamics Incorporated, uma empresa de treinamento para vendas, cita habilidades fracas na apresentação dos benefícios como uma das dez razões pelas quais os vendedores não conseguem realizar a venda. "Os clientes não compram produtos ou serviços", explica a empresa. "Eles compram o que esses produtos e serviços vão fazer por eles. No entanto, muitos vendedores descrevem apenas os recursos, supondo que o cliente conheça os benefícios. Os vendedores precisam saber como traduzir recursos em benefícios e apresentá-los com uma linguagem centrada no cliente."

Isso se aplica aos copywriters. Os novatos tendem a escrever sobre os recursos: fatos, números e estatísticas disponíveis. Copywriters experientes transformam esses recursos em benefícios para o cliente:  
razões pelas quais o leitor deve comprar o produto.

Aqui está uma simples técnica para descobrir os benefícios de um produto. Divida uma folha de papel em duas colunas. Rotule a coluna da esquerda de "Recursos" e a coluna da direita de "Benefícios". Na da esquerda, anote todas as características do produto. Algumas delas você encontrará no material de base que coletou sobre o produto (o capítulo 5 informa qual material de base coletar). O resto você pode aprender examinando e usando o produto ou conversando com as pessoas envolvidas com ele: clientes, vendedores, distribuidores ou engenheiros.

Em seguida, vá descendo a lista de recursos e pergunte a si mesmo: "Que benefício esse recurso oferece ao cliente? Como esse recurso torna o produto mais atraente, útil, agradável ou acessível?"

Ao completar a lista, a coluna da direita irá conter todos os benefícios que o produto oferece ao cliente. Esses são os argumentos de venda que devem ser incluídos na sua copy.

Faça esse exercício com um produto doméstico comum que você tenha por perto. Abaixo está minha lista de verificação de recursos/benefícios de um lápis n° 2. Você consegue adicionar outras coisas a essa lista ou pensar em uma maneira mais forte de declarar seus benefícios?

|RECURSOS|BENEFÍCIOS|
|---|---|
|Lápis é um cilindro de madeira.|Você pode apontá-lo sempre que quiser para garantir uma escrita clara.|
|O cilindro é hexagonal.|Não sai rolando na sua mesa.|
|Uma extremidade tem uma borracha.|Uma boa borracha corrige erros de escrita de forma limpa e rápida.|
|A borracha é presa por uma tira de metal bem ajustada.|Mantém a borracha no lugar; o lápis não se estraga com a borracha se soltando.|
|O lápis tem 19 cm de comprimento.|O grafite de 19 cm garante uma vida longa ao lápis.|
|Tem 0,64 cm de diâmetro.|A forma fina o torna fácil de segurar e confortável para escrever.|
|O lápis é número 2.|O grafite é uma mistura que garante a dureza certa - escreve de forma suave e nítida.|
|Amarelo por fora.|Exterior brilhante e atraente — se destaca em um estojo ou na gaveta da mesa.|
|Vendido à dúzia.|Uma única parada na loja lhe garante lápis suficientes que irão durar por meses.|
|Também disponível em uma caixa contendo 144 lápis.|Compra fácil e com menor preço unitário para usuários de grande volume, como escritórios comerciais e escolas.|
|Feito nos EUA.|Um produto de qualidade. Além disso, como são feitos nos EUA, eles fortalecem a economia americana.|

Agora que você tem uma lista de benefícios para o cliente, deve decidir qual argumento de venda é o mais importante e que será colocado no título como "tema" do anúncio. Você também deve decidir quais dos outros argumentos serão incluídos e quais não usará. Esses argumentos devem ser organizados em algum tipo de ordem lógica.

Vamos dar uma olhada em uma sequência prática de cinco etapas que poderá ajudá-lo a colocar seus argumentos de vendas em uma ordem que levará o leitor do interesse inicial à venda final.

# A sequência motivadora

Ao longo dos anos, muitos redatores de publicidade desenvolveram "fór-mulas de copy" para estruturar anúncios, comerciais e cartas de vendas.

A mais conhecida dessas fórmulas é a AIDA, que significa Atenção, Interesse, Desejo e Ação.

De acordo com a AIDA, a copy deve, em primeiro lugar, chamar a atenção do leitor. Depois, criar o interesse pelo produto, transformar esse interesse em um forte desejo de ter o produto e, finalmente, pedir ao leitor que compre ou que realize outra ação que culminará, por fim, na venda.

A segunda fórmula bem conhecida é a ACCA: Conscientização (Awareness, em inglês), Compreensão, Convicção e Ação. Na ACCA, primeiramente os consumidores passam a ter consciência de que o produto existe. Então eles devem compreender o que é o produto e o que ele fará por eles. Após a compreensão, os leitores devem ser convencidos a comprar o produto e, finalmente, realizar uma ação e fazer a compra.

Uma terceira fórmula famosa são os 4 Ps: Imagem (Picture, em inglês), Promessa, Prova e Impulso (Push, em inglês). O copywriter cria uma imagem do que o produto pode fazer pelo leitor, promete que a imagem se tornará realidade se o leitor comprar o produto, prova o que o produto fez pelos outros e impulsiona uma ação imediata.

A quarta e minha favorita é a "sequência motivadora": uma fórmula de cinco etapas para escrever uma copy que vende.
...
Você compra equipamentos esportivos para se divertir. Você vai para um spa para se cuidar. Você compra um clipe de dinheiro folheado a ouro para se destacar e se sentir importante.

Você compra seguros para estar seguro. Você compra chinelos para ficar confortável. Você compra uma geladeira que produz cubos de gelo pela conveniência.

Depois de entender o que motiva as pessoas a comprarem coisas, você saberá como vender — e como redigir uma copy. O resto é apenas organização, uma boa edição e aplicação de algumas técnicas básicas.

# Copy longa versus copy curta

Este era o slogan de um antigo comercial de cigarros: "Não importa em quanto tempo você faz, mas como faz." Essa é uma boa regra para determinar o tamanho da copy que você escreve. Em outras palavras, a questão não é quantas palavras você deve escrever; é quanta informação incluir para que a copy cumpra sua missão de venda.

No geral, o tamanho dependerá de três coisas: produto, público-alvo e propósito da copy. Pense, em primeiro lugar, no produto. Há muita coisa que você pode dizer sobre ele? Fornecer esses fatos ajudará a convencer o leitor a comprá-lo?

Alguns produtos têm muitos recursos e benefícios que você pode destacar em sua copy. Isso inclui computadores, caixas de som Bluetooth, carros, livros, apólices de seguro, oportunidades de investimento, cursos e seminários, resorts e viagens de férias, relógios digitais, smartphones e equipamentos para exercícios em casa.

Muitos outros produtos não têm tantos recursos e benefícios, e não há muito o que dizer sobre eles. Isso inclui refrigerantes, fast food, doces, goma de mascar, cerveja, vinho, bebidas alcoólicas, joias, lingerie, colônia, perfume, sabonete, sabão em pó, cosméticos, roupa de cama, ração para pets e xampu.

Por exemplo, não há muito o que dizer sobre um novo refrigerante, além de ser saboroso e custar menos.

Mas um processador automático de alimentos tem muitos benefícios que você pode enfatizar. Ele economiza tempo; elimina cortes irregulares e evita que as pessoas se cortem; torna mais fácil e agradável o ato de cozinhar; fatia, corta, tritura, descasca, mistura, pica e esmaga literalmente qualquer alimento. Você pode usá-lo para fazer sobremesas, aperitivos, saladas e pratos principais. Pode processar frutas, legumes, carnes, nozes e queijos.

Portanto, o tamanho da copy depende do produto e das informações disponíveis sobre ele.

Em segundo lugar, o tamanho da copy depende do público-alvo. Alguns clientes não precisam de muitas informações e não estão acostumados a ler textos longos. Outros procuram todos os dados que puderem obter e vão devorar tudo o que você puder fornecer.

Um clube do livro queria saber quanto texto incluir na copy do pacote da mala direta usada para atrair novos membros. Foram testados vários tamanhos de cartas de vendas: uma, duas, quatro, oito e doze páginas. A carta de doze páginas foi a que mais recebeu pedidos. Por quê? Uma das razões é que as pessoas que entram para um clube do livro são leitoras - e elas irão ler as doze páginas se acharem o assunto interessante.

Empresários cujo serviço ou produto gira em torno de propriedade intelectual ou metodologia técnica muitas vezes escrevem livros descrevendo sua abordagem ao serviço (por exemplo, gestão de investimentos). Muitos me disseram a mesma coisa: "Um cliente em potencial que realmente lê o livro se torna um cliente em potencial melhor e tem muito mais probabilidade de se tornar um cliente. Preferimos um cliente bem-informado. Eles são mais fáceis de lidar e mais propensos a aceitar nossas recomendações."

O terceiro fator para determinar o tamanho da copy é o propósito dela. Se você deseja que sua copy gere um lead de vendas, não há necessidade de entrar em detalhes complexos. Você terá a chance de fornecer mais informações quando as pessoas responderem ao lead. Por outro lado, um anúncio que solicita o pedido pelo correio deve fornecer todas as informações de que o leitor precisa para tomar uma decisão de compra e encomendar o produto.

“Tudo isso é muito legal", você diz, "mas como determino qual é o melhor tamanho de copy para meu produto, meu público e meu propósito?"

Felizmente, a resposta existe. Desenvolvi uma ferramenta que chamo de "grade de tamanho da copy" (figura 4.1), que nos permite determinar o tamanho da copy de uma forma um pouco mais científica e semiquantitativa.

A grade de tamanho da copy diz que são dois os fatores principais que determinam se uma copy longa ou curta funcionará melhor para sua promoção: emoção e envolvimento.

O fator _emoção_ se refere ao grau emocional da compra. Comprar um anel de noivado de diamante é uma decisão altamente emocional. Mas você se emociona muito pouco ao decidir por qual marca de clipes de papel comprar.

![[Pasted image 20260730121458.png]]

Já o fator envolvimento se refere a quanto tempo, esforço e pensamento são direcionados para a compra do produto. Assim como acontece na maioria das grandes compras, deve-se considerar muito bem sobre a escolha e a compra de um anel de noivado de diamante. Entretanto, a maioria de nós pega a primeira caixa de clipes de papel na prateleira da papelaria sem pensar duas vezes.

Para usar esse sistema e determinar o tamanho da copy, classifique estes dois critérios — emoção e envolvimento — como alto ou baixo. Isso determinará em qual quadrante da grade de tamanho da copy você vai se situar e fornecerá, no mínimo, uma orientação aproximada para o tamanho dela.

Por exemplo, a compra altamente emocional de um anel de noivado de diamante é uma "compra considerada" — algo em que você pensa muito —, por isso tem alto índice de envolvimento. Como você pode ver no diagrama, isso nos coloca firmemente no quadrante superior esquerdo da grade, indicando que a copy longa é mais apropriada para essa oferta.

Por outro lado, os clipes são mais classificados como compra por impulso: vamos à loja e pegamos a primeira caixa que vemos, desde que seja do tamanho certo. Não existe emoção e pensamos muito pouco nessa compra.

Isso nos coloca no quadrante inferior direito da grade, o que indica que escrever uma copy longa e apaixonada sobre clipes de papel provavelmente não resultará em mais vendas.

Obviamente, a grade de tamanho da copy servirá apenas para guiá-lo, e não fornecerá a você uma análise precisa. Vários outros fatores também devem ser considerados ao determinar o tamanho da copy. Esses fatores incluem:

- **Preço.**  
    Quanto mais caro for um produto, mais copy você precisará para vendê-lo. Muitas opções serão necessárias para construir o caso de valor antes de pedir que o cliente compre, de modo que, quando o preço for finalmente dado, pareça uma gota no meio do oceano em comparação ao que o comprador receberá em troca.
- **Propósito.**  
    Uma copy que vende o produto diretamente pela página impressa ou tela (conhecida como copy de "uma etapa" ou de "compra pelo correio") geralmente precisa ser longa, pois deve apresentar todas as informações do produto e superar todas as objeções. A copy desenvolvida para gerar um lead ("copy de duas etapas") pode ser curta, pois um catálogo, folheto ou vendedor terá a oportunidade de apresentar posteriormente os detalhes do produto e superar as objeções.
- **Público-alvo.**  
    Pessoas pressionadas pelo tempo, como executivos e profissionais ocupados, geralmente respondem melhor a uma copy curta. O copywriter interempresarial Steve Slaunwhite observa: "O estilo de escrita interempresarial tende a ser claro, baseado em fatos, informal e focado em expectativas de desempenho realistas, em vez de conter promessas exageradas. Clientes em potencial com mais tempo disponível, como aposentados e aqueles que se interessam bastante pela sua oferta, como aficionados por um hobby, são mais propensos a ler uma copy longa.
- **Importância.**  
    Os produtos de que as pessoas precisam (uma geladeira ou ar-condicionado) podem ser vendidos por uma copy curta porque... bem, o cliente em potencial precisa comprá-los. Os produtos que as pessoas querem, mas não precisam comprar (vídeos de exercícios, áudios de autoajuda, boletins financeiros) devem ser "vendidos" e exigem uma copy longa para isso.
- **Familiaridade.**  
    A copy curta funciona bem com produtos já familiares ao cliente em potencial. É por isso que vouchers e cartões postais duplos são usados com tanta frequência para vender assinaturas de revistas populares e conhecidas (Newsweek, Businessweek).

Com base na grade de tamanho da copy e nesses outros fatores, fica claro que a copy longa nem sempre será a melhor, e há muitos casos em que a copy curta ou quase inexistente funciona melhor. Esse é o caso de itens que "se vendem sozinhos", como grampeadores ou mangueiras de jardim.

Mas, para os itens que precisam ser "vendidos" — apólices de seguro de vida, automóveis de luxo, sistemas de TI, colecionáveis, joias de grande valor, treinamento profissional —, muitas vezes será necessária uma copy longa devido ao alto grau de emoção e envolvimento.

Não tenha medo de uma copy longa. Inclua quantas informações forem necessárias para fazer a venda.

Ao mesmo tempo, outros fatores também afetam o tamanho da copy. Por exemplo, em um banner ou anúncio do tipo link patrocinado do Google, você está limitado a uma copy curta. Ao clicar no anúncio, a pessoa é levada para uma página de vendas on-line. Ali, você terá o espaço necessário para dizer tudo o que precisa para fechar o negócio.

# Marketing geracional

Hoje, talvez mais do que nunca, os anunciantes estão direcionando seu marketing para gerações específicas. Os baby boomers e os millenials são as que mais prevalecem. O quadro 4.1 fornece uma rápida visão geral das várias gerações, incluindo as idades, interesses, atitudes e estilos de vida.

Por causa do ritmo acelerado em que a tecnologia está se desenvolvendo, da economia volátil, da instabilidade geopolítica e da expectativa de vida mais longa, as gerações talvez estejam se diferenciando mais do que nas décadas passadas — e por esse motivo, o marketing direcionado a gerações específicas tornou-se comum e extremamente eficaz.

| **Características**                       | **Maduros (pré-1945)**    | **Baby Boomers (1945–1960)**                                                                                                                                                                                          | **Geração X (1961–1980)**                                                                                                                                                                                                                                                                                        | **Geração Y (1981–1995)**                                                                                                                                                                    | **Geração Z (nascido depois de 1995)**                                                                                                                                                                                              |
| ----------------------------------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Experiências Formativas**               | Segunda Guerra            | Guerra Fria <br><br>Prosperidade (boom) pós-guerra <br><br>Swing dos anos 60 <br><br>Pouso do homem na Lua <br><br>Cultura jovem <br><br>Woodstock <br><br>Orientada para a família <br><br>Ascensão dos adolescentes | Fim da Guerra Fria <br>Queda do Muro de Berlim <br><br>Reagan/Gorbachev <br><br>Thatcherismo <br><br>Live Aid (festival beneficente de música) <br><br>Apresentação do primeiro computador pessoal <br><br>Nova tecnologia móvel <br><br>Filhos de pais que trabalham fora <br><br>Níveis crescentes de divórcio | Ataques terroristas de 11 de setembro <br><br>Playstation <br><br>Mídia Social <br><br>Invasão do Iraque <br><br>Reality shows <br><br>Google Earth <br><br>Glastonbury (festival de música) | Desaceleração econômica <br><br>Aquecimento global <br><br>Foco Global <br><br>Dispositivos móveis <br><br>Crise energética <br><br>Primavera árabe <br><br>Produção da própria mídia <br><br>Computação em nuvem <br><br>WikiLeaks |
| Aspirações                                | Casa própria              | Estabilidade profissional                                                                                                                                                                                             | Equilíbrio entre vida pessoal e profissional                                                                                                                                                                                                                                                                     | Liberdade e flexibilidade                                                                                                                                                                    | Segurança e estabilidade                                                                                                                                                                                                            |
| Atitude em relação à tecnologia           | Altamente desapegados     | Se adaptam à nova tecnologia da informação (TI)                                                                                                                                                                       | Imigrantes digitais                                                                                                                                                                                                                                                                                              | Nativos digitais                                                                                                                                                                             | “Tecnoholics” — inteiramente dependentes de TI, compreensão limitada de alternativas                                                                                                                                                |
| Atitude em relação à carreira             | Empregos para toda a vida | Organizacional — carreiras definidas pelos empregadores                                                                                                                                                               | Primeiras carreiras de “portfólio” — leais à profissão, e não necessariamente ao empregador                                                                                                                                                                                                                      | Empreendedores digitais — trabalham “com” empresas, e não “para”                                                                                                                             | Carreiras tarefas — se movimentam entre empresas e oportunidades temporárias                                                                                                                                                        |
| Sonho de consumo                          | Automóvel                 | Televisão                                                                                                                                                                                                             | Computador pessoal                                                                                                                                                                                                                                                                                               | Tablet/Smartphone                                                                                                                                                                            | Óculos Google, grafeno, nanotecnologia, impressão 3D, carros sem motorista                                                                                                                                                          |
| Meios de comunicação                      | Carta-padrão              | Telefone                                                                                                                                                                                                              | E-mail e mensagem de texto                                                                                                                                                                                                                                                                                       | Mensagem ou mídia social                                                                                                                                                                     | Dispositivos portáteis (ou integrados em roupas)                                                                                                                                                                                    |
| Preferência de comunicação                | Cara a cara               | Cara a cara idealmente, telefone ou e-mail se necessário                                                                                                                                                              | e-mail                                                                                                                                                                                                                                                                                                           | On-line e em dispositivos móveis (mensagens de texto)                                                                                                                                        | Facetime                                                                                                                                                                                                                            |
| Preferência ao tomar decisões financeiras | Reuniões presenciais      | Reuniões presenciais, mas cada vez mais on-line.                                                                                                                                                                      | On-line — Prefere presencial se o tempo permitir                                                                                                                                                                                                                                                                 | Presencial                                                                                                                                                                                   | Soluções serão digitais                                                                                                                                                                                                             |

# Posicionamento
Al Ries e Jack Trout, autores de [[Posicionamento - HUB|Posicionamento: a batalha por sua mente, escreveram]]: "Hoje, o posicionamento é usado em um sentido mais amplo. Ele significa o que a publicidade faz pelo produto na mentedo cliente em potencial. Em outras palavras, um anunciante de sucesso hoje usa a publicidade para posicionar seu produto, e não para comunicar suas vantagens ou características."

Por exemplo, a Coors está posicionada como uma cerveja fresca e pura, produzida com água das Montanhas Rochosas. A Heineken está posicionada como uma cerveja premium "feita por quem conhece"

O posicionamento não substitui os recursos, benefícios e argumentos de vendas; ele os complementa. Se o seu produto atende a um nicho especial, posicioná-lo em relação a uma marca conhecida é uma maneira rápida e eficaz de estabelecer a identidade do produto na mente do consumidor.

Mas sua copy deve fazer mais do que levar o consumidor a pensar sobre o produto; deve também persuadi-lo a comprar. E você não pode persuadir consumidores a comprar a não ser que diga o que o produto pode fazer por eles e por que é melhor que os da concorrência.