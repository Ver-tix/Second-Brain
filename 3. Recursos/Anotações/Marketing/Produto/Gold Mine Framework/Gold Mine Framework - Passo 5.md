...
autor: Steph France
---
# Passo 5 - Crie a Landing Page
1. Diga à IA (a mesma usada até agora, como o Claude ou Gemini), qual foi o nicho escolhido
2. Use o **Landing Page Prompt Creator** ainda na ferramenta de IA atual - ele é um prompt de geração de um novo prompt para uso no lovable
```markdown
Next AI Prompt: Generate a Lovable Prompt for a Landing Page
Your new mission From all the information in the conversation above, your new mission is to generate the best possible Lovable.dev prompt for creating a high-converting landing page.
...
Think step by step
	...
	2	Extract the best possible customer wording from the AI-generated business insights to maintain authenticity.
	3	Craft a landing page structure that follows Lovable’s best UI/UX practices and adheres to conversion best practices.
	4	Generate the perfect Lovable.dev prompt, ensuring the AI produces not only great copy but also an effective design.
...
Output: A full Lovable.dev prompt that the user can copy and paste into Lovable to generate a fully functional, high-converting landing page.




Final Step
Once the Lovable.dev prompt is generated, review it to ensure: ✅ It includes clear instructions for layout & design. ✅ It follows conversion copywriting principles. ✅ It uses real customer insights from the previous conversation. ✅ It’s structured for Lovable to execute flawlessly.
